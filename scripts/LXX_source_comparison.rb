...
# The purpose of this script is to compare two different sources of the Septuagint
# in order to determine if they are the same. If they are, then we can use the extra
# sources from one with the other (Strong's numbers, glossary definitions, etc.).
